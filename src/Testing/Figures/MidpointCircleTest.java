...
public class MidpointCircleTest extends MyJFrame{
    ...
    public MidpointCircleTest() {
        ...
        circle = new MidpointCircle(panel, g2);
    }
    ...
    public static void main(String[] args) {
        MidpointCircleTest test = new MidpointCircleTest();
