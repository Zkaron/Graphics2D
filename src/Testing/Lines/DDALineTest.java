 ...
 */
public class DDALineTest extends MyJFrame {
    private final String FRAME_TITLE = "DDA Line";
    ...
    public static void main(String[] args) {
        DDALineTest test = new DDALineTest();
